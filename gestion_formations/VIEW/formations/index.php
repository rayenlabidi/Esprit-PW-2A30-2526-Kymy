<?php $pageTitle = t('formations.frontoffice_title'); require __DIR__ . '/../layouts/header.php'; ?>

<section class="page-head">
    <div>
        <p class="eyebrow"><?= t('formations.module') ?></p>
        <h1><?= t('formations.frontoffice_title') ?></h1>
        <p class="muted"><?= t('formations.frontoffice_copy') ?></p>
    </div>
    <?php if (has_role(['admin', 'freelancer'])): ?>
        <a class="btn btn-primary" href="<?= url(['module' => 'formations', 'action' => 'backoffice']) ?>"><?= t('formations.manage') ?></a>
    <?php endif; ?>
</section>
