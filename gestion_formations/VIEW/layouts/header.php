...
<header class="site-header">
    <div class="container nav-shell">
        <a class="brand" href="<?= url(['module' => 'formations', 'action' => 'index']) ?>">
        ...
        <nav class="main-nav">
            <a class="<?= current_action() === 'index' ? 'active' : '' ?>" href="<?= url(['module' => 'formations', 'action' => 'index']) ?>"><?= t('nav.catalog') ?></a>
            <?php if (has_role(['admin', 'freelancer'])): ?>
                <a class="<?= current_action() === 'backoffice' ? 'active' : '' ?>" href="<?= url(['module' => 'formations', 'action' => 'backoffice']) ?>"><?= t('nav.backoffice') ?></a>
            <?php endif; ?>
        </nav>
        <div class="nav-actions">
            ...
            <?php if (is_logged_in()): ?>
                <span class="ghost-link"><?= h(auth_user()['first_name']) ?> (<?= h(auth_user()['role_name']) ?>)</span>
