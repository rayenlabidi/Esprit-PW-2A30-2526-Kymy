<?php
// Model/Event.php — Entity class for Event (v3 + GPS)
...
class Event
{
    ...
    public function setLatitude(?float $v): void       { $this->latitude = $v; }
    public function setLongitude(?float $v): void      { $this->longitude = $v; }
}
