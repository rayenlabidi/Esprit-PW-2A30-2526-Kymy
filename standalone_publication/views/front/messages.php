  ...
  <div class="msg-shell">
    ...
    <aside class="msg-panel-left" id="panelLeft">
      <div class="msg-panel-header">
        ...
        <div class="msg-filter-toggle" id="msgFilterToggle" style="display: flex; gap: 8px; margin-top: 15px; margin-bottom: 5px;">
          <button class="msg-filter-btn active" id="filterAllBtn" onclick="setConvFilter('all')">
            All
          </button>
          <button class="msg-filter-btn" id="filterUnreadBtn" onclick="setConvFilter('unread')">
            Unread <span class="msg-filter-count" id="unreadFilterCount" style="margin-left:4px;"><?php echo $unreadCount; ?></span>
          </button>
        </div>
      </div>
