...
class message
{
    ...
    public function __construct($sender_id, $receiver_id, $sender_name, $receiver_name, $sender_init, $receiver_init, $content, $sender_avatar = 'av-blue', $receiver_avatar = 'av-blue')
    {
